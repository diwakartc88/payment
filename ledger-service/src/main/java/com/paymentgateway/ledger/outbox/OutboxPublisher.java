package com.paymentgateway.ledger.outbox;
...
/** Same polling outbox publisher as payment-ingestion-service -- see that class's Javadoc for the production (CDC) note. */
@Slf4j
@Component
